  ...
  return (
    <div className="flex w-full max-w-[65ch] flex-col gap-4">
      <p className="text-regular font-bold leading-regular text-pretty text-foreground">
        ...
        Company, this is where I document and share new projects and
        experiments. You will find a mix of projects and labs below. Projects
        are sanitized reviews of confidential work, Labs are live experiments
        and studies.
      </p>
    </div>
  )
