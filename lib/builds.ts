...
export const buildProjects: readonly BuildProject[] = [
  ...
  },
  {
    ...
    description:
      'How to keep spirits high? Make gratitude contagious with an annual week-long Thank-a-thon that generates tens of thousands of thank you messages across the globe.',
    tags: ['zero-to-one'],
    image: {
